...
final class Capabilities {
    ...
    public const GROUPS = [
        ...
        'Voxel'                  => [ 'voxel:read', 'voxel:write', 'voxel:marketplace:read', 'voxel:marketplace:write', 'voxel:post-type:write', 'voxel:taxonomy:read', 'voxel:taxonomy:write', 'voxel:search:read', 'voxel:search:write' ],
