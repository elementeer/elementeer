...
final class Capabilities {
    ...
    public const ALL = [
        ...
        'voxel:post-type:write',
        'voxel:taxonomy:read',
        'voxel:taxonomy:write',
        'voxel:search:read',
        'voxel:search:write',
        'voxel:field:read',
        'voxel:field:write',
    ...
    public const LABELS = [
        ...
        'voxel:write'                    => 'Voxel — Write',
        'voxel:marketplace:read'         => 'Voxel Marketplace — Read',
        'voxel:marketplace:write'        => 'Voxel Marketplace — Write',
        'voxel:post-type:write'          => 'Voxel Post Type — Write',
        'voxel:taxonomy:read'            => 'Voxel Taxonomy — Read',
        'voxel:taxonomy:write'           => 'Voxel Taxonomy — Write',
        'voxel:search:read'              => 'Voxel Search — Read',
        'voxel:search:write'             => 'Voxel Search — Write',
        'voxel:field:read'               => 'Voxel Field — Read',
        'voxel:field:write'              => 'Voxel Field — Write',
    ...
    public const GROUPS = [
        ...
        'Voxel'                  => [ 'voxel:read', 'voxel:write', 'voxel:marketplace:read', 'voxel:marketplace:write', 'voxel:post-type:write', 'voxel:taxonomy:read', 'voxel:taxonomy:write', 'voxel:search:read', 'voxel:search:write', 'voxel:field:read', 'voxel:field:write' ],
